...
function _processOptions(options) {
  ...
  if (preservationOptions === 'all') {
    preservationOptions = {
      ...
      applyStyleIndents: true,
      applyStyleAlignment: true,
      applyStyleColor: true,
      applyStyleVertAlign: true,
    };
  }
  ...
  if (preservationOptions === 'default') {
    preservationOptions = {
      ...
      applyStyleIndents: false,
      applyStyleAlignment: false,
      applyStyleColor: false,
      applyStyleVertAlign: false,
    };
  }
